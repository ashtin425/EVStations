...
select distinct City, State, count(*) as 'EV Stations'
from EVChargerProject..ev_stations
group by City, State
order by count(*) desc

-- looking at cities with the most public EV Stations
select distinct City, State, count(*) as 'Public EV Stations'
from EVChargerProject..ev_stations
